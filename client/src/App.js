    ...
    return (
        <Router>
            <AuthProvider>
                <Routes>
                    {/* Public Layouts */}
                    {/* Render HomePageLayout as the container, and HomePage as its default content */}
                    <Route path="/" element={<HomePageLayout />}>
                        <Route index element={<HomePage />} /> {/* This renders HomePage at the / path within HomePageLayout */}
                    </Route>
